package com.kongling.platform.entity.VO.log;
...
@ApiModel(value="LogAppPc对象", description="系统日志")
public class LogAppPcVO extends Model<LogAppPcVO> {
