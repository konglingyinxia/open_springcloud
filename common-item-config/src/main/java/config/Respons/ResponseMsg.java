...
public class ResponseMsg {
    ...
    //=======================应用管理=================================
    public  static String PROJECT_HAS_EXIST_NOT_DEL="有应用为此类型,不能删除";

    //=======================汽车大亨游戏=================================

    public  static String BUILDINGS_HAS_OPEN="游戏地块已经开启！";
    public  static String BUILDINGS_NO_OPEN="游戏地块还未开启！";
    public  static String BUILDINGS_LEVEL_USER_UP="游戏上一地块基础级别未满级";
    public  static String BUILDINGS_UPGRADE_NO_FULL_UP="游戏升级上一级别还未满级！";
    public  static String BATTERY_OVER_TOP_50="电池电量大于50%不能充电！";
    public  static String GAME_OUTPUT_IS_INVALID="该游戏产出为无效产出！";
    public  static String GAME_UPDATE_CAPACITY_FAIL="游戏更新产能失败！";
    public  static String BUILDINGS_EDIT_OUTPUT_TIME_OVER120="产能产出时间间隔必须大于120分钟！";
    public static String GOLD_TRANSFER_NO_USE = "暂不能进行金币兑换！";
    public static String BUILDINGS_UPGRADE_BASIC_IS_FULL = "该级别基础级别已经满级！";
